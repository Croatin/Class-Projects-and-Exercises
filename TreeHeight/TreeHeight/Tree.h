...
private:
   ...
   int checkheight(TreeNode *);// proto for the checkheight function
...
int BinaryTree<T>::checkheight(TreeNode *nodeptr)
{
    ...
    //displaypostorder(root);
       ...
       int heightLeft = checkheight(nodeptr->left);
       int heightRight = checkheight(nodeptr->right);
...
int BinaryTree<T>::nodeCounter(TreeNode *nodePtr)
{
    ...
    else 
	{
        ...
        count += nodeCounter(nodePtr->left);  
        count += nodeCounter(nodePtr->right); 
